    ...
    json: function json(options) {
        ...
        return dataProvider.Post.findAll(data, options).then(function (result) {
            if (result) {
                ...
                result=(_.map(result, function(x){if(x.status==='published' && !x.page) return {title:x.title, slug:x.slug, image:x.image,created_at:x.created_at}}))
                var cleanFoo = [];
                for (var i in result) {

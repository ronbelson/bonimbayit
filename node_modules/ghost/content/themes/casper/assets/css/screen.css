...
.business-header {
  padding-top: 50px;
    ...
    /*background: url('/img/home-background/slide5.jpg') center center no-repeat scroll;*/
...
.construction-report-img img {
   padding-top:0px; 
   max-width: 90%;
   float:right;
     }

h1.tagline { padding-top:40px;
